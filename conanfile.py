...
class SqlcipherConan(ConanFile):
    ...
    def _build_visual(self):
        ...
        nmake_flags = [
                ...
                "OPTS=\"-I%s -DSQLITE_HAS_CODEC -DSQLITE_ENABLE_COLUMN_METADATA\"" % (crypto_incdir),
                "NO_TCL=1",
                "USE_AMALGAMATION=1",
    ...
    def _build_autotools(self):
        ...
        autotools_env.defines.extend(["SQLITE_HAS_CODEC", "SQLCIPHER_CRYPTO_OPENSSL","SQLITE_ENABLE_COLUMN_METADATA"])
    ...
    def package_info(self):
        ...
        self.cpp_info.defines = ["SQLITE_HAS_CODEC", 'SQLCIPHER_CRYPTO_OPENSSL', 'SQLITE_TEMP_STORE=2', "SQLITE_ENABLE_COLUMN_METADATA"]
